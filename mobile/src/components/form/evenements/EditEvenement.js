...
function EditEvenement({ route, navigation }) {
  ...
  const [evenement, setEvenement] = React.useState({
    id: data["id"],
    name: data["name"],
    type: data["type"],
    date: data["date"],
  ...
  const onChangeDate = (event, selectedDate) => {
    ...
    setEvenement({ ...evenement, date: fDate });
    setShow(false);
  };
  ...
  const onChangeTime = (event, selectedTime) => {
    ...
    setHeure(fTime);
    setEvenement({ ...evenement, heure: fTime });
    setShowTime(false);
  };
  ...
  const onChangeNbrPlaces = (value) => {
    setEvenement({ ...evenement, nbrPlaces: value });
  };

  const onChangeDescription = (value) => {
    setEvenement({ ...evenement, description: value });
  };

  const editDataEvenement = async () => {
    const data = {
      id: evenement.id,
      name: evenement.name,
      date: evenement.date,
      ...
      <View>
        <View>
          ...
          <SelectList
            ...
            setSelected={(valType) =>
              setEvenement({ ...evenement, terrain_id: valType })
            }
            data={dataListTerrains}
            defaultOption={{
              key: evenement.terrain_id,
              value: evenement.terrain_id,
            }}
        ...
        <View>
          ...
          <SelectList
            setSelected={(valType) =>
              setEvenement({ ...evenement, payant: valType })
            }
            search={false}
            data={estPayant}
            save="value"
            defaultOption={{
              key: evenement.payant,
        ...
        <View>
          ...
          <Input
            ...
            value={evenement.nbrPlaces.toString()}
            leftIcon={
        ...
        <View>
          ...
          <SelectList
            setSelected={(valType) =>
              setEvenement({ ...evenement, type: valType })
            }
            search={false}
        ...
        <ButtonComponent titleBtn="MODIFIER" action={editDataEvenement} />
      </View>
    </ScrollView>
  );
}
